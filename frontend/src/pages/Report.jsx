// Report.jsx — warm radiance redesign
      ...
      {open && (
        <div style={{ padding:"0 18px 18px", borderTop:"1px solid var(--border)" }} className="fade-in">
          <div style={{ paddingTop:14 }}>
            ...
            <div style={{ display:"grid", gridTemplateColumns:item.ideal_answer?"1fr 1fr":"1fr", gap:16, marginBottom:20 }}>
              <div>
...
export default function Report() {
  ...
  useEffect(() => {
    interviewAPI.getReport(id).then(r => setReport(r.report)).catch(e => setError(e.message)).finally(() => setLoading(false));
  }, [id]);
  ...
  return (
    <div className="fade-in">
      ...
      <div className="card" style={{ marginBottom:32 }}>
        <h2 style={{ fontSize:16, fontWeight:700, marginBottom:18 }}>Q&A Breakdown <span style={{ fontSize:13, color:"var(--text-3)", fontWeight:400 }}>— tap to expand</span></h2>
