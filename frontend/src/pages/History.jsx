// History.jsx — warm radiance redesign
...
export default function History() {
  ...
  const filtered = filter === "all" ? history
    : history.filter(iv => iv.level === filter);
          ...
          {filtered.map((iv, idx) => {
            ...
            return (
              <div key={iv.id} className="card card-sm"
                style={{ display:"flex", alignItems:"center", gap:16, animation:`fadeIn 0.3s ease ${idx*0.04}s both`,
